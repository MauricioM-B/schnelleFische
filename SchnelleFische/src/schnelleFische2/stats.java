...
public class stats{																							//Beginn von public class SchnelleFische
	...
	public static void stat() {																				//Beginn von public static void stat
		...
		System.out.println("Es wurden insgesamt "+hPro+" Spiele gespielt.");
		fPro=fische/hPro*100;																				//Rechnet aus zu wie viel Prozent die Fische gewinnen
		System.out.println("Die Fische gewinnen zu "+fPro+" % mit "+fische+" Siegen.");						//Gibt aus zu wie viel Prozent die Fische gewonnen haben
		frPro=fischer/hPro*100;																				//Rechnet aus zu wie viel Prozent die Fischer gewinnen
		System.out.println("Die Fischer gewinnen zu "+frPro+" % mit "+fischer+" Siegen.");					//Gibt aus zu wie viel Prozent die Fischer gewonnen haben
